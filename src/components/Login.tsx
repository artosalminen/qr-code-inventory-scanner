      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8 sm:p-12 shadow-2xl backdrop-blur-xl bg-opacity-80">
          ...
          <p className="text-slate-400 text-center text-sm sm:text-base mb-8">
            Real-time equipment tracking and handoff management
          </p>
          ...
          <div className="space-y-3 mb-8">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-slate-50 font-medium text-sm">Real-time Tracking</p>
                <p className="text-slate-400 text-xs">Monitor box status instantly</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-blue-400 text-xl mt-1">✓</span>
              <div>
                <p className="text-slate-50 font-medium text-sm">QR Code Scanning</p>
                <p className="text-slate-400 text-xs">Quick check-in and check-out</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-blue-400 text-xl mt-1">✓</span>
              <div>
                <p className="text-slate-50 font-medium text-sm">Team Management</p>
                <p className="text-slate-400 text-xs">Role-based access control</p>
              </div>
            </div>
          </div>
